                ...
                choices: [
                    {
                        ...
                        next: {
                            dialogType: DialogType.NarratorDialog,
                            text: "Dadurch dass niemand eingreift fährt der Mitspieler fort:",
                            ...
                            next: {
                                ...
                                next: {
                                    dialogType: DialogType.NarratorDialog,
                                    text: "Einige Mitspieler lachen über die Kommentare des Mitspielers. Der Afrikanische Junge sieht sehr betrübt aus, da ihm keiner hilft, und der Trainer scheint von allem nichts mitzubekommen.",
                                    ...
                                    next: {
                                        ...
                                        choices: [
                                            {
                                                dialogType: DialogType.PlayerDialog,
                                                text: "Du ignorierst es erneut",

                                                next: {
                                                    dialogType: DialogType.NarratorDialog,
                                                    text: "Da erneut niemand eingreift sieht der Mitspieler keinen grund mit seinen verletzenden Aussagen aufzuhören.",
                                                    ...
                                                    next: {
                                                        ...
                                                        next: {
                                                            dialogType: DialogType.NarratorDialog,
                                                            text: "sagt er und zeigt auf die alten Schuhe des Afrikanischen Mitspielers.  Diesem ist es ersichtlich peinlich und tränen kommen aus seinen Augen.",
                                                            ...
                                                            next: {
                                                                ...
                                                                choices: [
                                                                    {
                                                                        dialogType: DialogType.PlayerDialog,
                                                                        text: "Du weißt deinen Mitspieler daraufhin das seine Schuhe auch nicht mehr die neusten sind",
                                                                    ...
                                                                    {
                                                                        dialogType: DialogType.PlayerDialog,
                                                                        text: "Du Konfrontierst den mitspieler, da es jetzt entschieden zu weit geht und drohst ihm den Trainer zu rufen",
                                            ...
                                            {
                                                dialogType: DialogType.PlayerDialog,
                                                text: "Du konfrontierst den Mitspieler",
                                                ...
                                                next: {
                                                    ...
                                                    next: {
                                                        ...
                                                        choices: [
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Du erkläst ihm das seine Aussagen keine witze sondern Rassistische Äußerungen sind",
                                                            ...
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Du versuchts ihm klar zu machen das es  für den Afrikanischen Jungen kein spaß ist",
                                            ...
                                            {
                                                dialogType: DialogType.PlayerDialog,
                                                text: "Du frägst einen anderen Mitspieler ob er die Aussage nicht verletzend findet",
                                                ...
                                                next: {
                                                    ...
                                                    next: {
                                                        ...
                                                        choices: [
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Ihr beschließt gemeinsam den Mitspieler zu konfrontieren",
                                                            ...
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Ihr geht zusammen zu dem Afrikanischen Mitspieler und redet mit Ihm",
                                                            ...
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Ihr wollt nach dem Training zum Trainer gehen und ihm davonberichten was passiert ist",
                    ...
                    },
                    {
                        ...
                        next: {
                            ...
                            next: {
                                ...
                                next: {
                                    dialogType: DialogType.NarratorDialog,
                                    text: "streitet der rassistische Mitspieler seine Schuld ab.",
                                    ...
                                    next: {
                                        ...
                                        choices: [
                                            {
                                                dialogType: DialogType.PlayerDialog,
                                                text: "Du wirfst deinen Mitspieler rassistisches Verhalten vor",
                                                ...
                                                next: {
                                                    ...
                                                    next: {
                                                        ...
                                                        choices: [
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Du wirst ungeduldig und lässt deinen Frustration freien lauf",
                                                            ...
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Du forderst deine anderen Mitspieler auf auch was dazu zu sagen",
                                                            ...
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Du unterstützt den afrikanischen Jungen mit seiner Erklärung ",
                                            ...
                                            {
                                                dialogType: DialogType.PlayerDialog,
                                                text: "Du mischt dich nicht mehr ein. Dein Trainer wird es schon regeln.",
                                                ...
                                                next: {
                                                    ...
                                                    next: {
                                                        ...
                                                        choices: [
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Du klärst die Situation auf",

                                                                next: {
                                                                    dialogType: DialogType.NarratorDialog,
                                                                    text: "Du beichtest deinem Trainer den Verlauf der Konfrontation und wie der afrikanische Junge grundlos beleidigt wurde.",
                                                                    ...
                                                                    next: {
                                                                        ...
                                                                        next: {
                                                                            dialogType: DialogType.NarratorDialog,
                                                                            text: "schob der rassistische Junge mit ein. Da niemand anderes etwas zu der Aufklärung der Situation beigetragen hat, wurde alles als ein freundlichen Raufen zwischen Freunden abgestempelt. Der Trainer war nicht gerade zufrieden mit dir, dass du ihn für sowas gerufen hast. Die Situation hat sich nicht gebessert und der Junge ließ immer wieder rassistische Beleidigung gegen den Afrikanischen Mitspieler fallen. Irgendwann wurde es ihm zu viel und er verließ das Team. Dich plagten Schuldgefühle. Wie hättest du diese Situation umgehen können.",
                                                                        }
                                                                    }
                                                                }
                                                            },
                                                            ...
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Du forderst deine anderen Mitspieler zum reden auf",
                                            ...
                                            {
                                                dialogType: DialogType.PlayerDialog,
                                                text: "Die ermutigst den afrikanischen Jungen die Situation aufzuklären.",

                                                next: {
                                                    dialogType: DialogType.NarratorDialog,
                                                    text: "Du stehst dem Jungen beiseite und ermutigst ihn die Situation aufzuklären. Mit deiner Hilfe ist der afrikanische junge in der Lage sich zu verteidigen. Der Trainer stellt in folge dessen den diskriminierenden Jungen zur Rede.",
                                                    ...
                                                    next: {
                                                        ...
                                                        next: {
                                                            ...
                                                            choices: [
                                                                {
                                                                    dialogType: DialogType.PlayerDialog,
                                                                    text: "\"Man kann Rassistische Bezeichnungen doch nicht als Scherz abstempeln!\"",
                                                                ...
                                                                {
                                                                    dialogType: DialogType.PlayerDialog,
                                                                    text: "Du machst im klar das die Situation für den afrikanischen Jungen nicht spaßig war",

                                                                    next: {
                                                                        dialogType: DialogType.NarratorDialog,
                                                                        text: "\"Würdest du das auch lustig finden, wenn ich anfange dich auf dein äußeres zu reduzieren ?\"",

                                                                        next: {
                                                                            dialogType: DialogType.NarratorDialog,
                                                                            text: "Der Junge blieb still und schüttelte leise den Kopf.",

                                                                            next: {
                                                                                dialogType: DialogType.PlayerDialog,
                                                                                text: "Also warum denkst du, dann das deine Aussagen lustig waren?",

                                                                                next: {
                                                                                    dialogType: DialogType.NarratorDialog,
                                                                                    text: "Der Trainer stimmte zu und forderte den diskriminierenden Jungen auf sich zu entschuldigen. Der schwarze Junge erhielt seine Entschuldigung. Das war nicht die einzige Konsequenz die der fehlverhaltende Junge bekommen hat. Bei erneuten Fehlverhalten drohte der Rauswurf aus der Fußballmannschaft.",
                                                                                }
                                                                            }
                                                                        }
                                                                    }
                    ...
                    {
                        dialogType: DialogType.PlayerDialog,
                        text: "Du konfrontierst den Mitspieler mit seiner Aussage",

                        next: {
                            dialogType: DialogType.NarratorDialog,
                            text: "\"Schämst du dich nicht solche rassistischen Aussagen zu posaunen, nur weil du auf seine Leistung eifersüchtig bist?",
                            ...
                            next: {
                                ...
                                next: {
                                    dialogType: DialogType.NarratorDialog,
                                    text: "Du merkst langsam, dass dein schwarzer Mitspieler dabei ist die Fassung zu verlieren. Die Situation spitzt sich zu, wenn du nichts unternimmst könnte die Situation handgreiflich enden.",
                                    ...
                                    next: {
                                        ...
                                        choices: [
                                                ...
                                                next: {
                                                    ...
                                                    next: {
                                                        ...
                                                        choices: [
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Den afrikanischen Jungen dazu ermutigen das er erzählt was passiert ist",
                                            ...
                                            {
                                                dialogType: DialogType.PlayerDialog,
                                                text: "Du hältst den afrikanischen Mitspieler zurück",
                                                ...
                                                next: {
                                                    ...
                                                    next: {
                                                        ...
                                                        choices: [
                                                            ...
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Euch von dem Jungen zu distanzieren",
                                                            ...
                                                            {
                                                                dialogType: DialogType.PlayerDialog,
                                                                text: "Die Provokationen zu ignorieren",
                                            ...
                                            {
                                                dialogType: DialogType.PlayerDialog,
                                                text: "Du fragst deine anderen Mitspielern ob sie helfen könnten",

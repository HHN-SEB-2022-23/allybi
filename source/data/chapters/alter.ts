...
export const alter: Chapter = {
    ...
    headDialog: {
        ...
        text: "Paul (20) ist gelernter Mechaniker und arbeitet seit kurzem in einem neuen Betrieb. Nachdem er sich in seinem neuen Umfeld eingearbeitet hat, sieht er Optimierungsmöglichkeiten beim täglichen Betriebsablauf. Er schreibt eine Liste mit Verbesserungsvorschlägen und übergibt sie seinem Vorgesetzten. Der Meister meint daraufhin: \"Ach, hör mir doch auf. Ich mach das jetzt seit 40 Jahren und lass mir von dir nicht sagen, wie ich meinen Job zu machen hab.” \n Du und ein paar andere Kollegen haben das Ganze mitbekommen, wie reagierst du?",
        ...
        next: {
            ...
            choices: [
                                ...
                                },
                                {
                                    ...
                                    next: {
                                        ...
                                        next: {
                                            dialogType:
                                                DialogType.NarratorDialog,
                                            text: "Nachdem ich Paul etwas aufgemuntert habe, schaue ich mir seine Liste an. Da ich seine Ideen für sinnvoll erachte, biete ich ihm an, zusammen mit ihm zum Meister zu gehen",
                                            next: {
                                                dialogType:
                                                    DialogType.PlayerDialog,
                                                ...
                                                next: {
                                                    dialogType:
                                                        DialogType.NarratorDialog,
                                                    text: "Er nimmt meinen Vorschlag dankend an. Ich unterstütze ihn beim Vorstellen  seiner Idee. Der Meister nimmt die Idee dieses Mal ernst und entschuldigt sich bei Paul.",
                                                },
                                            },
                                        },
                                    },
                    ...
                    next: {
                        ...
                        next: {
                            ...
                            next: {
                                ...
                                next: {
                                    dialogType: DialogType.NarratorDialog,
                                    text: "Er wird nachdenklich, vertraut aber meiner Einschätzung und fragt mich, was er als nächstes tun sollte.",
                ...
                },
                {
                    ...
                    next: {
                        dialogType: DialogType.NarratorDialog,
                        text: "Ich unterbreche meine Arbeit und gehe dazwischen. Beide halten inne und schauen mich fragend an.",
                                    ...
                                    next: {
                                        ...
                                        next: {
                                            ...
                                            next: {
                                                dialogType:
                                                    DialogType.NarratorDialog,
                                                text: "Nach einem skeptischen Blick hört er auf meinen Vorschlag und schaut sich Pauls Liste an. Nach ein paar Minuten gibt er zu, dass tatsächlich einige gute Ideen dabei sind und entschuldigt sich bei Paul.",
                                            },
                                        },
                                    },
                                },
                                        ...
                                        next: {
                                            ...
                                            next: {
                                                ...
                                                next: {
                                                    dialogType:
                                                        DialogType.NarratorDialog,
                                                    text: "Ich unterstütze ihn beim Vorstellen  seiner Idee. Der Meister nimmt die Idee dieses Mal ernst und entschuldigt sich bei Paul.",
                                                },
                                            },
                                        },
                                    },
